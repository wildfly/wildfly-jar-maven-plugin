Contributing to WildFly Bootable JAR Maven Plugin
==================================

Welcome to the WildFly Bootable JAR Maven Plugin project! We welcome contributions from the community. 
...
## Forking the Project 
To contribute, you will first need to fork the [wildfly-jar-maven-plugin](https://github.com/wildfly-extras/wildfly-jar-maven-plugin) repository. 

This can be done by looking in the top-right corner of the repository page and clicking "Fork".

The next step is to clone your newly forked repository onto your local workspace. 
This can be done by going to your newly forked repository, which should be at `https://github.com/USERNAME/wildfly-jar-maven-plugin`. 
...
## Issues
This project uses Github Issues to manage issues. All issues can be found [here](https://github.com/wildfly-extras/wildfly-jar-maven-plugin/issues). 
...
First `cd` to the directory where you cloned the project (eg: `cd wildfly-jar-maven-plugin`)

Add a remote ref to upstream, for pulling future updates.
For example:

```
git remote add upstream https://github.com/wildfly-extras/wildfly-jar-maven-plugin
```
To build `wildfly-jar-maven-plugin` run:
```bash
mvn clean install
```
